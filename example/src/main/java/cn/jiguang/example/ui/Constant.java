...
class Constant {
     ...
     * 客户端收到升级请求的处理
     */
    static final int OTA_UPGRADE_INFORM_REQ = 1016;

    /**
     * 上报OTA升级状态后的回复的处理
     */
    static final int REPORT_OTA_STATUS_RESPONSE = 1017;

    /**
     * OTA升级进度显示
     */
    static final int OTA_SHOW_PROGRESS = 1018;

    static final int OTA_MD5_CHECK_SUCCESS = 1019;
    ...
    static final String DEFAULT_REPORT_VERSION = "V1.0.3";
}
