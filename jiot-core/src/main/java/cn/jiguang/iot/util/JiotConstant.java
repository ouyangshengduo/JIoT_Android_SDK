...
public interface JiotConstant {
     ...
     * 标志当前SDK的版本
     */
    String SDK_VERSION = "1.0.3";
    /**
     * 标志当前版本的SDK的编译序号
     */
    int SDK_BUILDID = 15;

    String PLARTFORM = "android";
    ...
    String OTA_STATUS_REPORT_LOG = "jiotOTAStatusReportReq()| enter method .";
    ...
    int VERSION_MAX_LEN = 24;

    String CONNECT_CHANGE_IP_ADDRESS_CONTEXT = "CONNECT_CHANGE_IP_ADDRESS_CONTEXT";

    String CONNECT_FIRST_CONTEXT = "CONNECT_FIRST_CONTEXT";

    String CONNECT_THE_SAME_IP_ADDRESS_CONTEXT = "CONNECT_THE_SAME_IP_ADDRESS_CONTEXT";

    String SUBSCRIBE_ERROR_DISCONNECT_CONTEXT = "SUBSCRIBE_ERROR_DISCONNECT_CONTEXT";

    String PUBLISH_TIMEOUT_DISCONNECT_CONTEXT = "PUBLISH_TIMEOUT_DISCONNECT_CONTEXT";

    String AUTO_DISCONNECT_CONTEXT = "AUTO_DISCONNECT_CONTEXT";

    String RELEASE_JCLIENT_DISCONNECT_CONTEXT = "RELEASE_JCLIENT_DISCONNECT_CONTEXT";
