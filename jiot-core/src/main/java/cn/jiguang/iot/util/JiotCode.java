...
public class JiotCode {
     ...
     * ota DESC格式错误
     */
    public static final int JIOT_ERR_OTA_DESC_FORMAT_ERROR = 15001;

    /**
     * ota STEP错误
     */
    public static final int JIOT_ERR_OTA_STEP_VALUE_ERROR = 15002;

    /**
     * ota异常
     */
    public static final int JIOT_ERR_OTA_FORMAT_ERROR = 15003;
     ...
     * 版本异常
     */
    public static final int JIOT_ERR_VERSION_APP_ERROR = 10019;
