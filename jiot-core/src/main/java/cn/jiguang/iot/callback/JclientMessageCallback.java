...
public interface JclientMessageCallback {
    ...
    /**
     * 服务端下发给JIOT客户端升级请求
     * @param otaUpgradeInformReq 客户端接收的升级请求消息
     * @param errorCode 错误码
     */
    void jiotOTAUpgradeInformReq(OtaUpgradeInformReq otaUpgradeInformReq, int errorCode);

    /**
     * 处理服务端返回JIOT客户端上报OTA升级状态回复
     * @param otaStatusReportRsp 服务器回复的OTA升级状态信息
     * @param errorCode 错误码
     */
    void jiotOTAStatusReportRsp(OtaStatusReportRsp otaStatusReportRsp, int errorCode);
