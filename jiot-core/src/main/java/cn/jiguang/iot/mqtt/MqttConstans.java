...
public class MqttConstans {
    ...
    /**OTA模块新增topic**/
    public static final String JMQTT_TOPIC_OTA_UPGRADE_INFORM_REQ = "sub/sys/%s/%s/ota/upgrade_inform";
    public static final String JMQTT_TOPIC_OTA_UPGRADE_INFORM_RSP = "pub/sys/%s/%s/ota/upgrade_inform_resp";
    public static final String JMQTT_TOPIC_OTA_STATUS_REPORT_REQ = "pub/sys/%s/%s/ota/status_report";
    public static final String JMQTT_TOPIC_OTA_STATUS_REPORT_RSP = "sub/sys/%s/%s/ota/status_report_resp";
