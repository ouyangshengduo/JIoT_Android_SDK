...
public abstract class AbstractMqttHandleCallback {
     ...
     * @param msg           连接信息
     */
    public abstract void onConnectCompleted(Status status, Object userContext, String msg);
     ...
     * @param msg         详细信息
     */
    public abstract void onPublishCompleted(Status status, IMqttToken token, Object userContext, String msg);
     ...
     * @param msg         详细信息
     */
    public abstract void onUnSubscribeCompleted(Status status, IMqttToken token, Object userContext, String msg);
     ...
     * @param message      消息内容
     */
    public abstract void onMessageReceived(String topic, MqttMessage message);
}
